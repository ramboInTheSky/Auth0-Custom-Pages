...
const webpackConfig = require('../webpack.config.password_reset')
      ...
      browserSync({
        ...
        server: {
          ...
          middleware: [
            ...
            // Serve password_reset.html for all unknown requests
            (req, res, next) => {
              if (req.headers.accept.startsWith('text/html')) {
                const filename = path.join(bundler.outputPath, 'password_reset.html')
